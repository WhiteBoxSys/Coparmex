                    ...
                    <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <!-- TODO: Aqui vas a mostrar una imagen que estará en la base de datos la cual la pondras en la variable del atributo src en este caso, en vez de estar "img/blog-1.jpg", estaría algo tipo $mostrar_datos['ruta_imagen'] usando las propiedades de php con el objeto de mysql -->
