        ...
        <div class="row g-5">
            <div class="col-lg-8">
                <div class="row g-5">
                    ...
                    foreach (obtenerBlogsPublicados() as $celda) {
                    ?>
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" data-src="assets/img/blog-1.jpg" alt="">
                                    <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4" href=""><?php echo $celda['id_categoria']  ?></a>
                                </div>
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i class="far fa-user text-primary me-2"></i><?php echo $celda['autor']  ?></small>
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i><?php echo $celda['creado']  ?></small>
                                    </div>
                                    <h4 class="mb-3"><?php echo $celda['titulo']  ?></h4>
                                    <p><?php echo $celda['descripcion']  ?></p>
